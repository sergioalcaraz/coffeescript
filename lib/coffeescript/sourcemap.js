  ...
  var SourceMap = (function() {
    ...
    class SourceMap {
      ...
      add(sourceLocation, generatedLocation, options = {}) {
        var base;
        var [line, column] = generatedLocation;
        var lineMap = ((base = this.lines)[line] || (base[line] = new LineMap(line)));
      ...
      generate(options = {}, code = null) {
        ...
        var buffer = "";
        var ref = this.lines;
        for (var i = 0, lineNumber = i, len = ref.length; i < len; lineNumber = ++i) {
          var lineMap = ref[lineNumber];
          if (lineMap) {
            var ref1 = lineMap.columns;
        ...
        var sources = options.sourceFiles ? options.sourceFiles : options.filename ? [options.filename] : ['<anonymous>'];
        var v3 = {
          version: 3,
    ...
    var VLQ_CONTINUATION_BIT = 1 << VLQ_SHIFT; // 0010 0000

    var VLQ_VALUE_MASK = VLQ_CONTINUATION_BIT - 1; // 0001 1111
