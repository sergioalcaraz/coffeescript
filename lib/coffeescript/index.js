...
(function() {
  ...
  var helpers = CoffeeScript.helpers;
  ...
  var universalCompile = CoffeeScript.compile;
  ...
  CoffeeScript.run = function(code, options = {}) {
    ...
    // Compile.
    var answer = CoffeeScript.compile(code, options);
  ...
  CoffeeScript.eval = function(code, options = {}) {
    var _module, _require, ref, ref1;
    if (!(code = code.trim())) {
      return;
    }
    var createContext = (ref = vm.Script.createContext) != null ? ref : vm.createContext;
    var isContext = (ref1 = vm.isContext) != null ? ref1 : function(ctx) {
    ...
    if (createContext) {
      ...
      if (!(sandbox !== global || sandbox.module || sandbox.require)) {
        ...
        var ref3 = Object.getOwnPropertyNames(require);
        for (var i = 0, len = ref3.length; i < len; i++) {
          var r = ref3[i];
    ...
    var js = CoffeeScript.compile(code, o);
    if (sandbox === global) {
  ...
  CoffeeScript._compileRawFileContent = function(raw, filename, options = {}) {
    ...
    try {
      var answer = CoffeeScript.compile(stripped, options);
    } catch (error) {
      var err = error;
