...
(function() {
  ...
  var o = function(patternString, action, options) {
    ...
    if (action) {
      ...
      var getAddDataToNodeFunctionString = function(first, last, forceUpdateLocation = true) {
      ...
      // `new Access`”.
      var returnsLoc = /^LOC/.test(action);
      ...
      var performActionFunctionString = `$$ = ${getAddDataToNodeFunctionString(1, patternCount, !returnsLoc)}(${action});`;
    } else {
