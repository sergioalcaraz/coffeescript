...
(function() {
  ...
  CoffeeScript.eval = function(code, options = {}) {
    ...
    var globalRoot = typeof window !== "undefined" && window !== null ? window : global;
  ...
  CoffeeScript.runScripts = function() {
    ...
    for (var j = 0, i = j, len = coffees.length; j < len; i = ++j) {
